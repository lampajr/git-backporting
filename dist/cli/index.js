...
;// CONCATENATED MODULE: ./build/package.json
const package_namespaceObject = JSON.parse('{"u2":"@kie/git-backporting","i8":"4.8.4","WL":"Git backporting is a tool to execute automatic pull request git backporting."}');
...
;// CONCATENATED MODULE: ./build/src/service/args/cli/cli-args-parser.js




class CLIArgsParser extends ArgsParser {
    getCommand() {
        return new Command(package_namespaceObject.u2)
...
;// CONCATENATED MODULE: ./build/src/bin/cli.js


// create CLI arguments parser
const cli_parser = new CLIArgsParser();
// create runner
const runner = new Runner(cli_parser);
runner.run();
